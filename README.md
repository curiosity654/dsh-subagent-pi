...
The implementation follows [GitHub Issue #1](https://github.com/curiosity654/dsh-subagent-pi/issues/1). Product direction is recorded in [ROADMAP.md](./ROADMAP.md), while domain terminology and architectural decisions live in [CONTEXT.md](./CONTEXT.md) and [docs/adr](./docs/adr/).
